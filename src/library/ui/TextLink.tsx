...
const TextLink = ({ variant = "body2", children, onPress, isPressed, ...rest }: TextLinkProps) => {
	...
	return (
		<Text onPress={onPress} color={typeColor} variant={variant} testID="button-text" textDecorationLine="underline" {...rest}>
			{children}
		</Text>
	);
};
