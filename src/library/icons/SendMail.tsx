...
const SvgSendMail = (props: SvgProps) => (
	<Svg width={24} height={24} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
		...
		/>
		<Rect x={-0.001} y={8} width={3} height={2} rx={1} fill={props?.fill ?? "#273142"} />
		<Rect x={1.999} y={12} width={7} height={2} rx={1} fill={props?.fill ?? "#273142"} />
		<Rect x={-0.001} y={16} width={6} height={2} rx={1} fill={props?.fill ?? "#273142"} />
	</Svg>
);
